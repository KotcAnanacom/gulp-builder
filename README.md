...
### Ngrok
С версии 1.0.4 добавлена возможность автоматически создать **Ngrok** сервер, который доступен каждому пользователю с ссылкой. Для этого надо зарегистрироваться - [Ngrok](https://ngrok.com). После регестрации перейти в свой кабинет и найти [AuthToken](https://dashboard.ngrok.com/get-started/your-authtoken) и вставить в `config.json` в нужный параметр, так же переставить **enabled** на _true_
